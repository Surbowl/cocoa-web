# 😆 core-me (*use-Redis*)
__这里是 use-Redis Branch，[点击此处](https://github.com/Surbowl/core-me)回到 master Branch__
<br><br>
...
<br><br>
### 留言板防骚扰
此 Branch 将访问者的 IP 与留言时间存储在 Redis 中，实现了更强健的防骚扰功能。请访问项目根目录下的 appsettings.json 与 appsettings.Development.json 文件，按照注释编辑您的 Redis 配置。
<br><br>
### 使用 Kestrel 部署项目
